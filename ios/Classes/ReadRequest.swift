...
class ReadRequest {
    ...
    private init(type: String, sampleType: HKSampleType, unit: HKUnit, dateFrom: Date, dateTo: Date, limit: Int?, interval: Int) {
        self.type = type;
    ...
    static func fromCall(call: FlutterMethodCall) throws -> ReadRequest {
        ...
        return ReadRequest(type: type, sampleType: sampleType, unit: unit, dateFrom: dateFrom, dateTo: dateTo, limit: limit, interval: interval)
    }
}
